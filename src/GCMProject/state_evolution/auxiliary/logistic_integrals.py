...
def integrate_for_mhat(M, Q, V, Vstar):
    I1 = quad(lambda ξ: f_mhat_plus(ξ, M, Q, V, Vstar) * utility.gaussian(ξ), -BOUND, BOUND, limit=500)[0]
    I2 = quad(lambda ξ: f_mhat_minus(ξ, M, Q, V, Vstar) * utility.gaussian(ξ), -BOUND, BOUND, limit=500)[0]
...
def integrate_for_Vhat(M, Q, V, Vstar, data_model = 'probit'):
    I1 = quad(lambda ξ: f_Vhat_plus(ξ, M, Q, V, Vstar) * utility.gaussian(ξ), -BOUND, BOUND, limit=500)[0]
    I2 = quad(lambda ξ: f_Vhat_minus(ξ, M, Q, V, Vstar) * utility.gaussian(ξ), -BOUND, BOUND, limit=500)[0]
    return (1/2) * (I1 + I2)
...
def integrate_for_Qhat(M, Q, V, Vstar):
    I1 = quad(lambda ξ: f_qhat_plus(ξ, M, Q, V, Vstar) * utility.gaussian(ξ), -BOUND, BOUND, limit=500)[0]
    I2 = quad(lambda ξ: f_qhat_minus(ξ, M, Q, V, Vstar) * utility.gaussian(ξ), -BOUND, BOUND, limit=500)[0]
    return (1/2) * (I1 + I2)
...
def training_loss_logistic(M, Q, V, Vstar):
    ...
    """
    I1 = quad(lambda ξ: Integrand_training_loss_plus_logistic(ξ, M, Q, V, Vstar) * utility.gaussian(ξ), -BOUND, BOUND, limit=500)[0]
    I2 = quad(lambda ξ: Integrand_training_loss_minus_logistic(ξ, M, Q, V, Vstar) * utility.gaussian(ξ), -BOUND, BOUND, limit=500)[0]
    return (1/2)*(I1 + I2)
